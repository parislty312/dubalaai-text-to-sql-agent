...
echo "  3. Run the CLI: python -m src.cli --model qwen3-235b-a22b --strategy single --no-summary"
echo "     or without activation: uv run python -m src.cli --model qwen3-235b-a22b --strategy single --no-summary"
echo ""
